...
// qrByCode loads a batch QR by its short public code.
...
func (r *repo) incrementScanCount(ctx context.Context, qrID string) error {
...
func (r *repo) latestPlantLabPass(ctx context.Context, batchID string) (*domain.QCResult, error) {
...
// consignmentsByIDs loads consignment documents by ID — the fallback source
// of contributing-DCS ids and collection dates when the ledger events did not
// carry them in org_unit_id/payload. Input is bounded by the trace event cap.
