...
func (r *Repo) ConsignmentsByIDs(ctx context.Context, ids []string) ([]domain.DCSConsignment, error) {
...
func (r *Repo) ClaimConsignments(ctx context.Context, ids []string, bmcLotID string) (int64, error) {
...
func (r *Repo) ReleaseConsignments(ctx context.Context, bmcLotID string) error {
...
func (r *Repo) BMCLotByID(ctx context.Context, id string) (*domain.BMCLot, error) {
...
func (r *Repo) BMCLotsByIDs(ctx context.Context, ids []string) ([]domain.BMCLot, error) {
...
func (r *Repo) CloseBMCLot(ctx context.Context, id string, tempC float64, closedAt time.Time) (bool, error) {
...
// match this update.
func (r *Repo) DispatchBMCLot(ctx context.Context, id string, dispatchedAt time.Time) (bool, error) {
	res, err := r.bmcLots.UpdateOne(ctx,
...
func (r *Repo) ClaimBMCLots(ctx context.Context, ids []string, batchID string) (int64, error) {
...
func (r *Repo) ReleaseBMCLots(ctx context.Context, batchID string) error {
...
// BMCLotListFilter narrows the BMC lot listing.
...
func (r *Repo) BatchByID(ctx context.Context, id string) (*domain.ProcessingBatch, error) {
...
func (r *Repo) CompleteBatch(ctx context.Context, id string, completedAt time.Time) (bool, error) {
...
// BatchListFilter narrows the batch listing.
...
func (r *Repo) ProductLotByID(ctx context.Context, id string) (*domain.ProductLot, error) {
...
func (r *Repo) RecallProductLot(ctx context.Context, id, reason string) (bool, error) {
...
func (r *Repo) DeleteQR(ctx context.Context, id string) error {
...
func (r *Repo) TouchActiveLot(ctx context.Context, lotID string) (bool, error) {
	res, err := r.productLots.UpdateOne(ctx,
...
// QRListFilter narrows the QR listing.
...
func (r *Repo) SetBMCLotProvenanceSeq(ctx context.Context, id string, seq int64) error {
	return r.setProvenanceSeq(ctx, r.bmcLots, id, seq)
}

// SetBatchProvenanceSeq stamps the ledger sequence onto a batch document.
func (r *Repo) SetBatchProvenanceSeq(ctx context.Context, id string, seq int64) error {
	return r.setProvenanceSeq(ctx, r.batches, id, seq)
}

// SetProductLotProvenanceSeq stamps the ledger sequence onto a product lot.
func (r *Repo) SetProductLotProvenanceSeq(ctx context.Context, id string, seq int64) error {
	return r.setProvenanceSeq(ctx, r.productLots, id, seq)
}

// SetQRProvenanceSeq stamps the ledger sequence onto a QR document.
func (r *Repo) SetQRProvenanceSeq(ctx context.Context, id string, seq int64) error {
	return r.setProvenanceSeq(ctx, r.qrs, id, seq)
}

func (r *Repo) setProvenanceSeq(ctx context.Context, coll *mongo.Collection, id string, seq int64) error {
